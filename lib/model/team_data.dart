...
const List<TeamMember> kDevTeamMembers = [
  ...
  TeamMember(
    ...
    linkedinUrl: 'https://www.linkedin.com/in/divyansh-gupta-749936393?utm_source=share_via&utm_content=profile&utm_medium=member_android',
  ),
  TeamMember(
    name: 'Hasini R',
...
const List<HeadMember> kFestHeads = [
  HeadMember(
    ...
    teamName: 'CONVENOR',
    imageUrl: 'assets/hero/meetheads/convenor.jpeg',
  ...
  HeadMember(
    ...
    imageUrl: 'assets/hero/meetheads/Fh_raghav_techniche.jpeg',
  ...
  HeadMember(
    ...
    imageUrl: 'assets/hero/meetheads/marketing_hardik.jpeg',
    linkedinUrl: 'https://www.linkedin.com/in/hardik-jain-1a5296214',
  ),
  HeadMember(
    name: 'Ayush Ranjan',
    designation: 'DevOps Head',
    teamName: 'DEVOPS HEAD',
    imageUrl: 'assets/ayush-app.jpg',
    linkedinUrl: 'https://www.linkedin.com/in/ayush-ranjan469?utm_source=share_via&utm_content=profile&utm_medium=member_android',
  ),
  HeadMember(
    ...
    imageUrl: 'assets/hero/meetheads/EVENT_HEAD_LOSHANYANAIDU.jpeg',
  ...
  HeadMember(
    ...
    designation: 'Events Head',
    teamName: 'EVENTS TEAM',
    imageUrl: 'assets/hero/meetheads/event_head_ritik.jpeg',
  ...
  HeadMember(
    ...
    designation: 'Events Head',
    teamName: 'EVENTS TEAM',
    imageUrl: 'assets/hero/meetheads/event_head_vaibhav.jpeg',
  ...
  HeadMember(
    ...
    imageUrl: 'assets/hero/meetheads/PRB HEAD_SHRADDHAN.jpeg',
    linkedinUrl: 'https://www.linkedin.com/in/shraddhan-singhai-b11786282',
  ),
  HeadMember(
    name: 'Asmi Basak',
    designation: 'Creatives & Branding Head',
    teamName: 'CREATIVES TEAM',
    imageUrl: 'assets/hero/meetheads/resi_head_asmi.jpeg',
  ...
  HeadMember(
    ...
    designation: 'Creatives & Branding Head',
    teamName: 'CREATIVES TEAM',
    imageUrl: 'assets/hero/meetheads/creative_head_nancy.jpeg',
  ...
  HeadMember(
    ...
    designation: 'Creatives & Branding Head',
    teamName: 'CREATIVES TEAM',
    imageUrl: 'assets/hero/meetheads/creative_head_shreya.png',
