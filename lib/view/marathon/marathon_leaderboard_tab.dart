    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // ── 2. HEADER BUTTONS (Back + Logout side by side) ─────────
          // ── 2. HEADER BUTTONS (Back + Logout side by side) ─────────
          SafeArea(
            child: Padding(
        ...
        Padding(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              // Each bar takes exactly 1/3 of available width
                ...
                children: [
                  ...
                  if (topThree.length >= 2)
                    _buildPodiumBar(topThree[1], 2,
                        const Color(0xFF3E72D7), 153, 'assets/ghm/2nd.png', barWidth),
                  const SizedBox(width: 16),
                  if (topThree.isNotEmpty)
                    _buildPodiumBar(topThree[0], 1,
                        const Color(0xFFF6BC2F), 217, 'assets/ghm/1st.png', barWidth),
                  const SizedBox(width: 16),
                  if (topThree.length >= 3)
                    _buildPodiumBar(topThree[2], 3,
                        const Color(0xFF7C3EC3), 105, 'assets/ghm/3rd.png', barWidth),
  ...
  Widget _buildPodiumBar(_LeaderboardItem item, int rank,
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          // ── Name pill — fixed width, ellipsis if too long ──
          Container(
            width: barWidth - 8,
  ...
  Widget _buildLeaderboardTile(
    ...
    return Container(
      ...
      decoration: ShapeDecoration(
        color: isMe ? const Color(0xFFE8F0FE) : const Color(0xFFF3F3F3),
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        gradient: RadialGradient(
          ...
          radius: 1.50,
          colors: [Color(0xFF175BCC), Color(0xFF0B2D66)],
        ),
        boxShadow: [
          BoxShadow(
